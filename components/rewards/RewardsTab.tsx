            ...
            <div className="flex gap-3 min-w-max pb-1">
                {tabs.map((tab, index) => (
                    <button
                        ...
                        className={`
                            px-6 py-3 text-sm font-semibold transition-colors duration-300 whitespace-nowrap
                ...
                {/* Sliding Underline */}
                <div
                    className="absolute bottom-[-1px] h-1 bg-purple-700 transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) rounded-full"
                    style={{
